...
Release:    %{_release}
BuildArch:  x86_64
Requires: boost, libcurl, libmpdclient, ncurses, readline, taglib, mpd, tilix, cool-retro-term, gnome-terminal, cantata, tmux, ffmpeg, inotify-tools, fzf, mpc, python3-devel, python3-pip, mplayer, asciinema, libchromaprint-devel, dconf, util-linux, sqlite, libavdevice
