...
%else
Requires: alsa-utils, bc, boost, coreutils, flac, jq, libcurl, ncurses, readline, taglib, mediainfo, tmux, inotify-tools, figlet, fzf, mpc, python3-devel, python3-pip, libchromaprint-devel, dconf, util-linux, sqlite, wget, wmctrl, xdpyinfo, xprop, xrandr
%endif
