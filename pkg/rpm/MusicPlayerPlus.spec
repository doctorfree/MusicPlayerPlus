...
Release:    %{_release}
BuildArch:  x86_64
Requires: boost, flac, jq, libcurl, libmpdclient, ncurses, readline, taglib, mpd, cool-retro-term, tmux, inotify-tools, figlet, fzf, mpc, python3-devel, python3-pip, mplayer, libchromaprint-devel, dconf, util-linux, sqlite, libavdevice, wget, wmctrl, xprop, xorg-x11-utils, xorg-x11-server-utils
