...
Release:    %{_release}
BuildArch:  x86_64
Requires: boost, libcurl, libmpdclient, ncurses, readline, taglib, mpd, cool-retro-term, gnome-terminal, tmux, ffmpeg, inotify-tools, figlet, fzf, mpc, python3-devel, python3-pip, mplayer, libchromaprint-devel, dconf, util-linux, sqlite, libavdevice
